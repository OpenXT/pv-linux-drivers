...
#ifdef XEN_DKMS_ENLIGHTEN
struct { char _entry[32]; } xen_dkms_hcpage[PAGE_SIZE/32] __aligned(PAGE_SIZE);
#else
extern struct { char _entry[32]; } xen_dkms_hcpage[];
#endif

#define __HYPERCALL		"call xen_dkms_hcpage+%c[offset]"
#define __HYPERCALL_ENTRY(x)						\
	[offset] "i" (__HYPERVISOR_##x * sizeof(xen_dkms_hcpage[0]))
